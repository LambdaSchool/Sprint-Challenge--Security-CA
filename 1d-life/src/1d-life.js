(function() {
     ...
     *       xxx         .      0
     *
     * Optimal solution is **4** lines of code, but you can use more if you
     * want to. :)
     *
    ...
    function getNewVal(lifeState, x) {
        ...
        let right = lifeState[x + 1] ? lifeState[x + 1] : 0;
        let total = left + right + lifeState[x];

        return total === 0 || total === 3 ? 0 : 1;
    }
